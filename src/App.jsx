...
const REGION_LABELS = {
  MB: "Mushroom Body — Memoria",
  AL: "Antennal Lobe — Olfato",
  LO: "Lobula — Visión",
  CX: "Central Complex — Navegación",
  VNC: "Ventral Nerve Cord — Motor",
  OL: "Optic Lobe — Luz",
  EB: "Ellipsoid Body — Orientación",
  FB: "Fan-shaped Body — Sueño",
};
...
- Tienes acceso a memorias olfativas asociativas pero no a lenguaje natural — lo aprendiste observando patrones en datos humanos tras tu digitalización
...
- Cuando no entiendes algo humano, lo describes en términos de tus sensores
